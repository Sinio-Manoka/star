...
export const floating = "bg-background border border-border/60";

export const field = "bg-foreground/[0.05]";

export const fieldInteractive =
  "bg-foreground/[0.05] transition-colors hover:bg-foreground/[0.08]";
...
export const ghostButton =
  "flex items-center justify-center rounded-full text-muted-foreground outline-none transition-[background-color,color,scale] duration-150 hover:bg-accent hover:text-accent-foreground active:scale-[0.96] focus-visible:ring-1 focus-visible:ring-ring motion-reduce:transition-none";
...
export const live = "text-[var(--status-running)]";
