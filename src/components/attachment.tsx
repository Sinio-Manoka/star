  ...
  return (
    <AttachmentPrimitive.Remove
      render={
        <TooltipIconButton
          tooltip="Remove file"
          className="aui-attachment-tile-remove bg-(--media-control)! text-(--media-control-foreground) hover:bg-(--media-control)! hover:text-(--media-control-foreground)! absolute end-1 top-1 size-5 rounded-full after:absolute after:-inset-1.5 active:scale-[0.96] motion-reduce:transition-none"
          side="top"
        />
      }
    >
    ...
    <ComposerPrimitive.AddAttachment
      render={
        <TooltipIconButton
          ...
          variant="ghost"
          size="icon-xs"
          className="aui-composer-add-attachment text-muted-foreground hover:text-foreground hover:bg-muted-foreground/15 dark:border-muted-foreground/15 dark:hover:bg-muted-foreground/30 active:scale-[0.96] motion-reduce:transition-none"
