...
WINRT_EXPORT namespace winrt::Microsoft::UI::Composition
{
    ...
    enum class CompositionEngineType : int32_t
    {
        System = 0,
        InProcess = 1,
    };
...
namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Composition::ICompositionEngineStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall TrySetProcessEngine(int32_t, bool*) noexcept = 0;
            virtual int32_t __stdcall GetForSystemEngine(void*, void**) noexcept = 0;
            virtual int32_t __stdcall GetForInProcessEngine(void*, void**) noexcept = 0;
        };
    };
